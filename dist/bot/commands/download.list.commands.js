...
export function commandsDownload(botInfo) {
    const PREFIX = botInfo === null || botInfo === void 0 ? void 0 : botInfo.prefix, BOT_NAME = botInfo === null || botInfo === void 0 ? void 0 : botInfo.name;
    const download = {
        play: {
